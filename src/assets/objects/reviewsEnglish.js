const reviewsEnglish = [
    {
      testimonial: "Melisa possesses a great empathy and understanding of children's psychology. She spend time with children meaningfully and imaginatively, and in a subtle but suggestive way, she clearly sets boundaries and overcomes all delicate educational challenges. Children are always fulfilled and joyful after spending time with her.",
      writer: "Mina Babić"
    },
    ...
    {
      testimonial: "There isn't a better and more responsible babysitter in Belgrade than Melisa. She has done a great job with our little one, caring for and teaching her during the pandemic. I truly recommend it!",
      writer: "Branislav Nikolić"
    }

];

export default reviewsEnglish